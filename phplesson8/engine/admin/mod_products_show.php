<?
if   (isset($_POST['id_redact']) && $_POST['id_redact'] > 0)  $mode_or_add = "Редактирование товара";
else                		 								  $mode_or_add = "Добавление товара";
...
//  Группы товаров в виде списка ul,li 
$groups_list = doMenuGroupsAdmin($group, 0);  //doMenu($group, 0);
?>